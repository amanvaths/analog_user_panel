  ...
  (u.ClassBody = function () {
    ...
    (u.ClassNavMenu = function () {
      u.BreakClass("." + s, d.lg, { timeOut: 0 }),
        u.BreakClass("." + r, d.lg, { timeOut: 0, classAdd: e }),
        c.on("resize", function () {
          u.BreakClass("." + s, d.lg),
            u.BreakClass("." + r, d.lg, { classAdd: e });
        });
    }),
    (u.Prettify = function () {
      window.prettyPrint && prettyPrint();
      ...
      u.TGL.screen(n),
        ...
        l.on("mouseup", function (t) {
          ...
          s &&
            ((e = p(s)),
            (n = p(s).data("target")),
            (n = p('[data-content="'.concat(n, '"]'))),
            (a = p(".select2-container")),
            (i = p(".datepicker-dropdown")),
            (o = p(".ui-timepicker-container")),
            e.is(t.target) ||
      ...
      p(t || '[data-bs-toggle="modal"]').on("click", function () {
        ...
        t && "#" !== t && e
          ...
          : e &&
            ...
            (t = p(n[0]).find('[data-bs-toggle="tab"]')),
            p(t[0]).tab("show"));
      });
    }),
