                                ...
                                <div className="nk-block-head nk-block-head-sm">
                                    <div className="nk-block-between g-3">
                                        <div className="nk-block-head-content">
                                            <h3 className="nk-block-title page-title">Crypto Transaction</h3>
                                            ...
                                            <div className="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div className="toggle-expand-content" data-content="pageMenu">
                                                    <ul className="nk-block-tools g-3">
                                                        <li><a href="#" className="btn btn-white btn-dim btn-outline-light"><em className="icon ni ni-download-cloud"></em><span>Export</span></a></li>
                                                ...
                                                <div className="card-title-group">
                                                    ...
                                                    <div className="card-tools mr-n1">
                                                        <ul className="btn-toolbar gx-1">
                                                            <li>
                                                                <a href="#" className="search-toggle toggle-search btn btn-icon" data-target="search"><em className="icon ni ni-search"></em></a>
                                                            </li>
                                                                                ...
                                                                                <div className="col-6">
                                                                                    <div className="form-group">
                                                                                        <div className="custom-control custom-control-sm custom-checkbox">
                                                                                            ...
                                                                                            <label className="custom-control-label" for="includeDel"> Including Deleted</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                ...
                                                <div className="nk-tb-list nk-tb-tnx">
                                                    ...
                                                    <div className="nk-tb-item">
                                                        <div className="nk-tb-col">
                                                            <div className="nk-tnx-type">
                                                                ...
                                                                <div className="nk-tnx-type-text">
                                                                    ...
                                                                    <span className="tb-date">18/10/2019 12:04 PM</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="nk-tb-col tb-col-lg">
                                                            ...
                                                            <span className="badge badge-dot badge-success">Deposit</span>
                                                        </div>
                                                        <div className="nk-tb-col text-right">
                                                            <span className="tb-amount">+ 0.010201 <span>BTC</span></span>
                                                            <span className="tb-amount-sm">1290.49 USD</span>
                                                        </div>
                                                        <div className="nk-tb-col text-right tb-col-sm">
                                                            <span className="tb-amount">1.30910201 <span>BTC</span></span>
                                                        ...
                                                        <div className="nk-tb-col nk-tb-col-status">
                                                            ...
                                                            <span className="badge badge-sm badge-dim badge-outline-success d-none d-md-inline-flex">Completed</span>
                                                        </div>
                                                        <div className="nk-tb-col nk-tb-col-tools">
                                                            <ul className="nk-tb-actions gx-2">
                                                                <li className="nk-tb-action-hidden">
                                                                    <a href="#" className="bg-white btn btn-sm btn-outline-light btn-icon" data-toggle="tooltip" data-placement="top" title="Approve"><em className="icon ni ni-done"></em></a>
                                                                </li>
                                                                <li className="nk-tb-action-hidden">
                                                                    <a href="#tranxDetails" data-toggle="modal" className="bg-white btn btn-sm btn-outline-light btn-icon btn-tooltip" title="Details"><em className="icon ni ni-eye"></em></a>
                                                                </li>
                                                                <li>
                                                                    <div className="dropdown">
                                                                        <a href="#" className="dropdown-toggle bg-white btn btn-sm btn-outline-light btn-icon" data-toggle="dropdown"><em className="icon ni ni-more-h"></em></a>
                                                                        <div className="dropdown-menu dropdown-menu-right">
                                                                            <ul className="link-list-opt">
                                                                                <li><a href="#"><em className="icon ni ni-done"></em><span>Approve</span></a></li>
                                                                                <li><a href="#"><em className="icon ni ni-cross-round"></em><span>Reject</span></a></li>
                                                                                <li><a href="#"><em className="icon ni ni-repeat"></em><span>Check</span></a></li>
                                                                                <li><a href="#tranxDetails" data-toggle="modal"><em className="icon ni ni-eye"></em><span>View Details</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                    ...
                                                    <div className="nk-tb-item">
                                                        ...
                                                        <div className="nk-tb-col tb-col-lg">
                                                            <span className="tb-lead-sub">YWLX52JG73</span>
                                                            <span className="badge badge-dot badge-warning">Withdrawal</span>
                                                        </div>
                                                        <div className="nk-tb-col text-right">
                                                            <span className="tb-amount">+ 0.010201 <span>BTC</span></span>
                                                            <span className="tb-amount-sm">1290.49 USD</span>
                                                        ...
                                                        <div className="nk-tb-col nk-tb-col-status">
                                                            <div className="dot dot-success d-md-none"></div>
                                                            <span className="badge badge-sm badge-dim badge-outline-warning d-none d-md-inline-flex">Upcoming</span>
                                                        </div>
                                                        <div className="nk-tb-col nk-tb-col-tools">
                                                            <ul className="nk-tb-actions gx-2">
                                                                <li className="nk-tb-action-hidden">
                                                    ...
                                                    <div className="nk-tb-item">
                                                        ...
                                                        <div className="nk-tb-col tb-col-lg">
                                                            <span className="tb-lead-sub">YWLX52JG73</span>
                                                            <span className="badge badge-dot badge-info">Profit</span>
                                                        </div>
                                                        <div className="nk-tb-col text-right">
                                                            <span className="tb-amount">+ 0.010201 <span>BTC</span></span>
                                                            <span className="tb-amount-sm">1290.49 USD</span>
                                                        ...
                                                        <div className="nk-tb-col nk-tb-col-status">
                                                            ...
                                                            <span className="badge badge-sm badge-dim badge-outline-info d-none d-md-inline-flex">Pending</span>
                                                        </div>
                                                        <div className="nk-tb-col nk-tb-col-tools">
                                                            <ul className="nk-tb-actions gx-2">
                                                                <li className="nk-tb-action-hidden">
                                                    ...
                                                    <div className="nk-tb-item">
                                                        ...
                                                        <div className="nk-tb-col tb-col-lg">
                                                            <span className="tb-lead-sub">YWLX52JG73</span>
                                                            <span className="badge badge-dot badge-danger">Withdrawal</span>
                                                        </div>
                                                        <div className="nk-tb-col text-right">
                                                            <span className="tb-amount">+ 0.010201 <span>BTC</span></span>
                                                            <span className="tb-amount-sm">1290.49 USD</span>
                                                        ...
                                                        <div className="nk-tb-col nk-tb-col-status">
                                                            <div className="dot dot-success d-md-none"></div>
                                                            <span className="badge badge-sm badge-dim badge-outline-danger d-none d-md-inline-flex">Rejected</span>
                                                        </div>
                                                        <div className="nk-tb-col nk-tb-col-tools">
                                                            <ul className="nk-tb-actions gx-2">
                                                                <li className="nk-tb-action-hidden">
                                                    ...
                                                    <div className="nk-tb-item">
                                                        ...
                                                        <div className="nk-tb-col tb-col-lg">
                                                            <span className="tb-lead-sub">YWLX52JG73</span>
                                                            <span className="badge badge-dot badge-warning">Deposit</span>
                                                        </div>
                                                        <div className="nk-tb-col text-right">
                                                            <span className="tb-amount">+ 0.010201 <span>BTC</span></span>
                                                            <span className="tb-amount-sm">1290.49 USD</span>
                                                        ...
                                                        <div className="nk-tb-col nk-tb-col-status">
                                                            ...
                                                            <span className="badge badge-sm badge-dim badge-outline-warning d-none d-md-inline-flex">Pending</span>
                                                        </div>
                                                        <div className="nk-tb-col nk-tb-col-tools">
                                                            <ul className="nk-tb-actions gx-2">
                                                                <li className="nk-tb-action-hidden">
