                                                ...
                                                <div className="card-inner p-0">
                                                    <div className="nk-tb-list nk-tb-ulist is-compact">
                                                        <div className="nk-tb-item nk-tb-head">
                                                            ...
                                                            <div className="nk-tb-col"><span className="sub-text">Username</span></div>
                                                            <div className="nk-tb-col tb-col-md"><span className="sub-text">Wallet</span></div>
                                                            <div className="nk-tb-col tb-col-sm"><span className="sub-text">Salvage</span></div>
                                                            <div className="nk-tb-col tb-col-md"><span className="sub-text">Level</span></div>
                                                            <div className="nk-tb-col tb-col-xl"><span className="sub-text">Energy</span></div>
                                                            <div className="nk-tb-col tb-col-xl"><span className="sub-text">Shield</span></div>
                                                            <div className="nk-tb-col tb-col-xl"><span className="sub-text">Balance</span></div>
                                                            <div className="nk-tb-col"><span className="sub-text">Plebiscite</span></div>
                                                                        ...
                                                                        <ul className="link-tidy sm no-bdr">
                                                                            <li>
                                                                                <div className="custom-control custom-control-sm custom-checkbox">
                                                                                    ...
                                                                                    <label className="custom-control-label" for="bl">Balance</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" className="custom-control-input" checked="" id="ph" />
                                                                                    <label className="custom-control-label" for="ph">Phone</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" className="custom-control-input" id="vri" />
                                                                                    <label className="custom-control-label" for="vri">Verified</label>
                                                                                </div>
                                                                            </li>
                                                                            <li>
                                                                                <div className="custom-control custom-control-sm custom-checkbox">
                                                                                    <input type="checkbox" className="custom-control-input" id="st" />
                                                                                    <label className="custom-control-label" for="st">Status</label>
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                        ...
                                                        <div className="nk-tb-item">
                                                            ...
                                                            <div className="nk-tb-col tb-col-xl">
                                                                <ul className="list-status">
                                                                    <li><em className="icon text-info ni ni-alarm-alt"></em> <span>Email</span></li>
                                                                </ul>
                                                            </div>
                                                            <div className="nk-tb-col tb-col-xl">
                                                        ...
                                                        <div className="nk-tb-item">
                                                            ...
                                                            <div className="nk-tb-col tb-col-xl">
                                                                <ul className="list-status">
                                                                    <li><em className="icon ni ni-alert-circle"></em> <span>Email</span></li>
                                                                </ul>
                                                            </div>
                                                            <div className="nk-tb-col tb-col-xl">
                                                        ...
                                                        <div className="nk-tb-item">
                                                            ...
                                                            <div className="nk-tb-col tb-col-xl">
                                                                <ul className="list-status">
                                                                    <li><em className="icon text-warning ni ni-alarm-alt"></em> <span>Email</span></li>
                                                                </ul>
                                                            </div>
                                                            <div className="nk-tb-col tb-col-xl">
                                                        ...
                                                        <div className="nk-tb-item">
                                                            <div className="nk-tb-col nk-tb-col-check">
                                                                <div className="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" className="custom-control-input" id="uid11" />
                                                        ...
                                                        <div className="nk-tb-item">
                                                            <div className="nk-tb-col nk-tb-col-check">
                                                                <div className="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" className="custom-control-input" id="uid12" />
                                                        ...
                                                        <div className="nk-tb-item">
                                                            <div className="nk-tb-col nk-tb-col-check">
                                                                <div className="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" className="custom-control-input" id="uid13" />
                                                        ...
                                                        <div className="nk-tb-item">
                                                            <div className="nk-tb-col nk-tb-col-check">
                                                                <div className="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" className="custom-control-input" id="uid14" />
                                                        ...
                                                        <div className="nk-tb-item">
                                                            <div className="nk-tb-col nk-tb-col-check">
                                                                <div className="custom-control custom-control-sm custom-checkbox notext">
                                                                    <input type="checkbox" className="custom-control-input" id="uid15" />
