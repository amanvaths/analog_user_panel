                    ...
                    ><span
                      ...
                      ><span class="selection"
                        ><span
                          ...
                          tabindex="0"
                          aria-disabled="false"
                          aria-labelledby="select2-4ntk-container"
                          ><span
                            class="select2-selection__rendered"
                            id="select2-4ntk-container"
                            role="textbox"
                            aria-readonly="true"
                                        ...
                                        ><span
                                          ...
                                          ><span class="selection"
                                            ><span
                                              ...
                                              tabindex="0"
                                              aria-disabled="false"
                                              aria-labelledby="select2-1l9i-container"
                                              ><span
                                                class="select2-selection__rendered"
                                                id="select2-1l9i-container"
                                                role="textbox"
                                                aria-readonly="true"
                                                title="Any Role"
                                                >Any Role</span
                                        ...
                                        ><span
                                          ...
                                          ><span class="selection"
                                            ><span
                                              ...
                                              tabindex="0"
                                              aria-disabled="false"
                                              aria-labelledby="select2-dg7m-container"
                                              ><span
                                                class="select2-selection__rendered"
                                                id="select2-dg7m-container"
                                                role="textbox"
                                                aria-readonly="true"
                                                title="Any Status"
                                                >Any Status</span
          ...
          <div class="card-inner p-0">
            <div class="nk-tb-list nk-tb-ulist is-compact">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>Bangladesh</span></div>
                <div class="nk-tb-col tb-col-lg">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>10 Feb 2020</span></div>
                <div class="nk-tb-col">
                          ...
                          <ul class="link-list-opt no-bdr">
                            ...
                            <li>
                              <a href="#"
                                ...
                                ><span>Reset 2FA</span></a
                              >
                            </li>
                            <li>
                              <a href="#"
                                ><em class="icon ni ni-na"></em
                                ><span>Suspend User</span></a
                              >
                            </li>
                          </ul>
                        </div>
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-warning"><span>PN</span></div>
                    <div class="user-name">
                      <span class="tb-lead">Patrick Newman</span>
                    </div>
                  </div>
                </div>
                <div class="nk-tb-col tb-col-md"><span>Investor</span></div>
                <div class="nk-tb-col tb-col-sm">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>06 Feb 2020</span></div>
                <div class="nk-tb-col">
                  <span class="tb-status text-success">Active</span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-success"><span>HK</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>England</span></div>
                <div class="nk-tb-col tb-col-lg">
                  <ul class="list-status">
                    <li>
                ...
                <div class="nk-tb-col tb-col-xxl"><span>01 Feb 2020</span></div>
                <div class="nk-tb-col">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-purple"><span>AB</span></div>
                    <div class="user-name">
                      <span class="tb-lead">Albert Brown</span>
                    </div>
                  </div>
                </div>
                <div class="nk-tb-col tb-col-md"><span>Subscriber</span></div>
                <div class="nk-tb-col tb-col-sm">
                  <span>howard@example.com</span>
                </div>
                <div class="nk-tb-col tb-col-md">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>31 Jan 2020</span></div>
                <div class="nk-tb-col">
                  <span class="tb-status text-success">Active</span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-danger"><span>BH</span></div>
                    <div class="user-name">
                      <span class="tb-lead">Brian Hunter</span>
                    </div>
                  </div>
                </div>
                <div class="nk-tb-col tb-col-md"><span>Manager</span></div>
                <div class="nk-tb-col tb-col-sm">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>28 Jan 2020</span></div>
                <div class="nk-tb-col">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-dark"><span>TS</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-md"><span>+91 411-5392</span></div>
                <div class="nk-tb-col tb-col-xxl"><span>India</span></div>
                <div class="nk-tb-col tb-col-lg">
                  <ul class="list-status">
                    <li>
                      <em class="icon text-success ni ni-check-circle"></em>
                ...
                <div class="nk-tb-col tb-col-xxl"><span>26 Jan 2020</span></div>
                <div class="nk-tb-col">
                  <span class="tb-status text-info">Inactive</span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-success"><span>JC</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-md"><span>+91 483-6614</span></div>
                <div class="nk-tb-col tb-col-xxl"><span>India</span></div>
                <div class="nk-tb-col tb-col-lg">
                  <ul class="list-status">
                    <li>
                ...
                <div class="nk-tb-col tb-col-xxl"><span>21 Jan 2020</span></div>
                <div class="nk-tb-col">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-dark"><span>EC</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>China</span></div>
                <div class="nk-tb-col tb-col-lg">
                  <ul class="list-status">
                    <li>
                      <em class="icon text-info ni ni-alarm-alt"></em>
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-warning"><span>LN</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>18 Jan 2020</span></div>
                <div class="nk-tb-col">
                  <span class="tb-status text-success">Active</span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-success"><span>AC</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>11 Jan 2020</span></div>
                <div class="nk-tb-col">
                  <span class="tb-status text-success">Active</span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-primary"><span>JG</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>Vietnam</span></div>
                <div class="nk-tb-col tb-col-lg">
                  <ul class="list-status">
                    <li>
                      <em class="icon text-success ni ni-check-circle"></em>
                ...
                <div class="nk-tb-col tb-col-xxl"><span>10 Jan 2020</span></div>
                <div class="nk-tb-col">
                  <span class="tb-status text-success">Active</span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-danger"><span>GB</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>Singapore</span></div>
                <div class="nk-tb-col tb-col-lg">
                  <ul class="list-status">
                    <li>
                      <em class="icon text-success ni ni-check-circle"></em>
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-dark"><span>WL</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>Philippines</span></div>
                <div class="nk-tb-col tb-col-lg">
                  <ul class="list-status">
                    <li>
                      <em class="icon text-success ni ni-check-circle"></em>
                ...
                <div class="nk-tb-col tb-col-xxl"><span>05 Jan 2020</span></div>
                <div class="nk-tb-col">
                  <span class="tb-status text-warning">Pending</span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-warning"><span>FP</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>01 Jan 2020</span></div>
                <div class="nk-tb-col">
                  <span class="tb-status text-success">Active</span>
                </div>
                <div class="nk-tb-col nk-tb-col-tools">
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <div class="user-card">
                    <div class="user-avatar xs bg-success"><span>MB</span></div>
                    <div class="user-name">
                ...
                <div class="nk-tb-col tb-col-xxl"><span>Malaysia</span></div>
                <div class="nk-tb-col tb-col-lg">
                  <ul class="list-status">
                    <li>
                      <em class="icon text-warning/ ni ni-alarm-alt"></em>
