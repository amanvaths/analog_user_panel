                ...
                <div className="nk-block">
                   {
                    news.map((element, index)=>{
                      return(
                      <div className="card card-bordered shadow-sm" key={index}>
                      <div className="card-inner">
                        <div className="row g-gs">
                          <div className="col-lg-5">
                            <div className="video">
                              <img className="news_img_div w-100" src={`${BASE_URL_2}${element.image}`} alt="" />
                            </div>
                          </div>
                          <div className="col-lg-7">
                            <div className="product-details entry me-xxl-3">
                              ...
                              }} target="_blank" className="btn btn-sm btn-outline-success">Read More</b>
                            </div>
                          </div>
                        </div>
                  ...
                  {/* <div className="card card-bordered shadow-sm">
                    <div className="card-inner">
                      <div className="row g-gs">
                        <div className="col-lg-5">
                          <div className="video">
                            <img className="news_img_div" src="images/news/cryptocurrency.jpg" alt="" />
                          </div>
                        </div>
                        <div className="col-lg-7">
                          <div className="product-details entry me-xxl-3">
                            ...
                            <a href="/NewsArticle" target="_blank"  className="btn btn-sm btn-outline-success">Read More</a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="card card-bordered shadow-sm">
                    <div className="card-inner">
                      <div className="row g-gs">
                        <div className="col-lg-5">
                          <div className="video">
                            <img className="news_img_div" src="images/news/cryptocurrency3.jpg" alt="" />
                          </div>
                        </div>
                        <div className="col-lg-7">
                          <div className="product-details entry me-xxl-3">
