            ...
            <div class="card-inner bg-light">
                <div className="row">
                  <div className="col-6 border-right">
                    <h6 class="mb-1">{t('total_user')}</h6>{" "}
                    <p class="text-teal">{props.totalUser}</p>
                    <h6 class="mb-1">{t('total_analog_buy')}</h6>{" "}
                    <p class="text-teal">{props.totalAnalogBuy}</p>
                    <h6 class="mb-1">{t('total_expense')}</h6>{" "}
                    <p class="text-teal">{props.totalExpence}</p>
                  </div>
                  <div className="col-6">
                    <h6 class="mb-1">Total Affiliates</h6>{" "}
                    <p class="text-teal">{props.totalAffiliates}</p>
                    <h6 class="mb-1">{t('total_withdrawal')}</h6>{" "}
                    <p class="text-teal">{props.widthdrawl}</p>
                    <h6 class="mb-1">{t('total_remaining')}</h6>{" "}
